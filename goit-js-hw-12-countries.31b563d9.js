...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./js/app.js":"9f5IL"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
inputRef.addEventListener("input", (0, _lodashDebounceDefault.default)((e)=>{
    ...
    (0, _fetchCountriesDefault.default)(search).then((res)=>{
        ...
        if (res.length > 2 && res.length < 10) listRef.innerHTML = res.map((country)=>`<li>${country.altSpellings[1]}</li>`).join("");
        if (res.length === 1) {
            listRef.textContent = "";
            divRef.innerHTML = res.map((country)=>`
      <div class="before">
...
<img src="${country.flags.png}" alt="${country.flags.alt}" class="img">`).join("");
        }
    });
}, 500));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirec490", {})
